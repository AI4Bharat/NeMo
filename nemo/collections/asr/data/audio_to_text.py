...
def _speech_collate_fn(batch, pad_id):
    ...
    if len(packed_batch) == 6: # has language ids #CTEMO
...
class _AudioTextDataset(Dataset):
    ...
    def output_types(self) -> Optional[Dict[str, NeuralType]]:
        ...
        return {
            ...
            'language_id': [NeuralType(('B'), StringType(), optional=True)], #CTEMO
        }
    ...
    def __init__(
        ...
        self.return_language_id = return_language_id #CTEMO
    ...
    def __getitem__(self, index):
        ...
        if self.return_language_id: #CTEMO
